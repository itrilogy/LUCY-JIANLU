  ...
  return (
    <div className="flex w-screen flex-col bg-white lg:mx-auto lg:max-w-7xl">
      <header className="fixed left-0 right-0 top-0 z-50 flex items-center justify-between border-b border-emerald-900/10 bg-white/80 px-6 py-5 backdrop-blur-xl lg:px-12">
        ...
        >
          ...
          <div className="flex flex-col leading-tight">
            <h1 className="text-lg font-semibold tracking-tight text-[#0D5E42] lg:text-xl">
              见鹿
              <span className="ml-1.5 text-xs font-semibold tracking-[0.14em] text-[#0D5E42]/70">JianLu</span>
            </h1>
        ...
        <a
          href="/"
          className="flex items-center gap-1 rounded-xl bg-[#0D5E42] px-4 py-2.5 text-sm text-white transition-all duration-200 hover:bg-[#0a4a34] md:hidden"
        >
          <span>练习</span>
        ...
        <div className="mx-auto max-w-7xl">
          <ol className="flex items-center space-x-2 text-sm text-gray-500" itemScope itemType="https://schema.org/BreadcrumbList">
            <li itemProp="itemListElement" itemScope itemType="https://schema.org/ListItem">
              <a href="/" className="transition-colors hover:text-[#0D5E42]" itemProp="item">
      ...
      <main role="main">
        ...
        >
          ...
          <div className="relative z-10 mx-auto w-full max-w-5xl px-6 py-24 text-center">
            ...
            {/* 主标题 / Banner */}
            <h1 className="mb-6 text-5xl font-bold leading-[1.1] tracking-tight text-gray-900 sm:text-6xl lg:text-7xl" itemProp="name">
              <span className="text-[#0D5E42]">见鹿</span>
              <br />
              在练习中<span className="text-[#0D5E42]">看见</span>，于流动中<span className="text-[#00D2FF]">内化</span>
            </h1>
            ...
            <div className="mb-16 flex flex-wrap justify-center gap-3" itemProp="featureList">
              {['英语单词记忆', '文章段落练习', '知识词库', '音标发音', '默写巩固', '实时反馈'].map((item, index) => (
                <span
                  key={index}
                  className="rounded-full border border-emerald-900/10 bg-[#F5F7FA] px-6 py-3 text-sm font-medium text-gray-700 transition-all duration-200 hover:bg-white hover:shadow-sm"
                >
                  {item}
                </span>
              ))}
            ...
            <a
              href="/"
              className="inline-flex items-center gap-3 rounded-full bg-[#0D5E42] px-10 py-5 text-lg font-semibold text-white shadow-xl transition-all duration-300 hover:-translate-y-1 hover:bg-[#0a4a34] hover:shadow-2xl"
            >
              <span>立即开始</span>
            ...
            <div className="lg:grid lg:grid-cols-2 lg:gap-12">
              ...
              <div className="mt-16 flex h-[14rem] items-center justify-center rounded-3xl border border-gray-200 bg-white p-8 shadow-2xl lg:mt-0 lg:h-auto lg:p-12">
                <img
                  ...
                  alt={`鹿溪实验室 ${detail[activeIndex].title} 功能展示`}
                />
              </div>
            </div>
