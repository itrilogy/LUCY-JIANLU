...
const internationalExam: DictionaryResource[] = [
  ...
  {
    id: 'ielts-liuhongbo-538',
    name: '雅思刘洪波 538',
    description: '刘洪波雅思核心词汇精选',
    category: '国际考试',
    tags: ['IELTS'],
...
const childrenEnglish: DictionaryResource[] = [
  ...
  },
  {
    id: 'chuzhong-luan-2',
    name: '初中英语词汇（乱序）',
    description: '初中英语常用词汇乱序版',
    category: '青少年英语',
    tags: ['通用', '乱序'],
    url: '/dicts/ChuZhongluan_2_T.json',
    length: 1420,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'gaozhong-luan-2',
    name: '高中英语词汇（乱序）',
    description: '高中英语常用词汇乱序版',
    category: '青少年英语',
    tags: ['通用', '乱序'],
    url: '/dicts/GaoZhongluan_2_T.json',
    length: 3668,
    language: 'en',
    languageCategory: 'en',
  },
...
const programming: DictionaryResource[] = [
  ...
  },
  {
    id: 'node-path',
    name: 'Node: path',
    description: 'Node.js path 模块 API',
    category: '代码练习',
    tags: ['Node.js'],
...
/**
 * Knowledge 词库：从「文章/代码练习」板块提炼的分章节单词词典
 * 章序（每章约 20 词，CHAPTER_LENGTH）：
 * 1 程序基础 · 2 数据结构/异步 · 3 工程实践 · 4 复利与货币时间价值
 * 5 市场交易 · 6 风险量化 · 7 金融产品 · 8 SAFTI 经管
 * 9 行为与监管 · 10 知识工程 · 11 Mermaid/工作流 · 12 技术协作
 */
const knowledge: DictionaryResource[] = [
  {
    id: 'knowledge-from-articles',
    name: 'Knowledge 文章词汇',
    description:
      '综合词库：文章练习 + SAFTI 书单 + 双色球 FinTech 起步 + OOMWOO 机器人（约 940 词 / 约 48 章）',
    category: 'Knowledge',
    tags: ['Knowledge'],
    url: '/dicts/knowledge-from-articles.json',
    length: 943,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'knowledge-fintech-core',
    name: 'Knowledge · FinTech 核心词',
    description: '金融科技核心词：书单概念、利率风险、衍生品、行为金融、概率建模（220 词 / 约 11 章）',
    category: 'Knowledge',
    tags: ['Knowledge', 'FinTech'],
    url: '/dicts/knowledge-fintech-core.json',
    length: 220,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'knowledge-cs-core',
    name: 'Knowledge · CS 编程词',
    description: '计算科学核心词：编程语法、工程实践、ROS2/机器人、数据与 SQL（220 词 / 约 11 章）',
    category: 'Knowledge',
    tags: ['Knowledge', '编程'],
    url: '/dicts/knowledge-cs-core.json',
    length: 220,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'knowledge-ssq-fintech-start',
    name: 'Knowledge · 双色球 FinTech 起步',
    description:
      '从「双色球研究作业」提炼：爬虫、频次检验、Markov/GMM、反馈回路、庄家模型、工程化（85 词 / 约 5 章）',
    category: 'Knowledge',
    tags: ['Knowledge', 'FinTech', '量化起步'],
    url: '/dicts/knowledge-ssq-fintech-start.json',
    length: 85,
    language: 'en',
    languageCategory: 'en',
  },
  {
    id: 'knowledge-robotics-ros2',
    name: 'Knowledge · OOMWOO / ROS2',
    description:
      '从开源扫地机 OOMWOO 提炼：ROS2、SLAM、Nav2、Gazebo、嵌入式与安全（130 词 / 约 7 章）',
    category: 'Knowledge',
    tags: ['Knowledge', '编程', '机器人'],
    url: '/dicts/knowledge-robotics-ros2.json',
    length: 130,
    language: 'en',
    languageCategory: 'en',
  },
